...
d3.csv("month_df.csv").then(function(monthData) {

  console.log(monthData);

  // Cast the count value to a number for each piece of monthData
  ...
  // Create one SVG rectangle per piece of monthData
